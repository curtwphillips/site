      ...
      <div className="form-section" id="health-container">
        ...
        {/* <div className="note-row mt-3 mb-5">
          <Form.Group className="mb-3" controlId="noteInput">
            <Form.Control ref={categoryTextInputRef} onKeyPress={onCategoryInputKeyUp} className="inline thin-input mr-5" type="text" placeholder="enter category" />{'  '}
            <Form.Control ref={titleTextInputRef} onKeyPress={onTitleInputKeyUp} className="inline thin-input mr-5" type="text" placeholder="enter title" />{'  '}
            <Form.Control ref={noteTextInputRef} onKeyPress={onNoteInputKeyUp} className="inline thin-input mr-5" type="text" placeholder="enter note" />{'  '}
            <FontAwesomeIcon className="inline" icon={faPlus} onClick={addNote}/>
          </Form.Group>
        </div>
